...
type ListUser = (typeof listData)[0];
...
export function ReconnectScreen() {
  ...
  // Data source: replace listData/DUMMY_SWIPE_CARDS with API data when ready.
  // Swipe logic works with any ListUser[]; ensure API response matches ListUser shape (id, name, gender, location, image, and optionally bio, interests, occupation, education, events, mutualFriends, photos).
