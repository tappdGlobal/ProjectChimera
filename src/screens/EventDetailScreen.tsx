...
//     price: "₹1,200",
//     seatsLeft: 45,
//     perks: ["Entry to event", "1 Welcome drink", "Access to main floor"],
//   },
//   {
//     id: "2",
//     title: "Premium Pass",
//     price: "₹2,500",
//     seatsLeft: 23,
//     perks: ["Entry to event", "3 Premium drinks", "VIP lounge access"],
//   },
// ];
...
//   const { trackEvent, trackButtonClick } = useAnalytics("EventDetailScreen", {
//     event_id: event?.id,
...
//                 key={index}
//                 source={{ uri: img }}
//                 style={[styles.carouselImage, index === 0 && styles.firstImage]}
//               />
//             ),
//           )}
//         </ScrollView>
